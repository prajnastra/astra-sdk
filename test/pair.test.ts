...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x267Ae4bA9CE5ef3c87629812596b0D89EcBD81dD', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0x5d4685c2C75581C67b9D6292A065a767bC214681', 18, 'DAI', 'DAI Stablecoin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0xE2971049E83B948ecD28cD68e74EEA09c6fC7c50')
    })
  })
