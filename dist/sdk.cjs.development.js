...
var IBitgertSwapPair = _interopDefault(require('@evofinance9/bitgert-swap-core/build/IBitgertSwapPair.json'));

var _SOLIDITY_TYPE_MAXIMA;

(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 32520] = "MAINNET";
  ChainId[ChainId["TESTNET"] = 64668] = "TESTNET";
...
var FACTORY_ADDRESS = '0x456405E3d355ad27010Fd87e3c7cC8a2DcA372fD';
var INIT_CODE_HASH = '0xd0a65eee32c829677d84ce15b5d94f37807e582560fe4d4f2150bc81a70ba430';
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'BRISE', 'BRISE');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x0eb9036cbE0f052386f36170c6b07eF0a0E3f710', 18, 'WBRISE', 'Wrapped Brise'), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0xd063d22345421DfB9A884e5091D6d163e7D61aA5', 18, 'WBRISE', 'Wrapped Brise'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'BLP', 'Bitgert LPs');
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactBRISEForTokensSupportingFeeOnTransferTokens' : 'swapExactBRISEForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForBRISESupportingFeeOnTransferTokens' : 'swapExactTokensForBRISE'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapBRISEForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactBRISE'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.MAINNET] = {
  '0x267Ae4bA9CE5ef3c87629812596b0D89EcBD81dD': 18,
  '0x5d4685c2C75581C67b9D6292A065a767bC214681': 8,
  '0x0e11DCE06eF2FeD6f78CEF5144F970E1184b4298': 18
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IBitgertSwapPair.abi, provider).getReserves()).then(function (_ref) {
